...
const UIScene = new Phaser.Class({
  ...
  create() {
    setInterval(() => {
      bar = new HealthBar(this, 650, 10, life);
    }, 500);
    ...
    this.heroesMenu = new HeroesMenu(520, 430, this);
    this.actionsMenu = new ActionsMenu(330, 450, this);
    this.enemiesMenu = new EnemiesMenu(30, 430, this);
